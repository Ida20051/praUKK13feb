...
if (isset($_POST['simpan'])){
    ...
    $sql= "INSERT INTO tb_toko (id_bahan, nama_toko, alamat, no_siup, nama_pemilik) VALUES ('$bahan_id', '$nama_toko', '$alamat', '$nosiup', '$nama_pemilik')";
    $query= mysqli_query($koneksi, $sql);

    if($query){
        header('location:tampil.php?status=sukses');
    }else{
        header('locaation:tampil.php?status=gagal');
    }
}
